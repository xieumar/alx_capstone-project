...
function Navbar() {
  return (
    <div className=' fixed top-0 left-0 right-0 bg-white shadow-md z-10 h-18 flex items-center justify-between px-8'>
      ...
      <div className="searchbar w-[45%] relative">
        <input 
          ...
          className='w-full h-10 px-8 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-800'
        />
        <div className="search-icon absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500">
            <GoSearch />
        </div>
      </div>

    <div className="nav-links w-[35%] ml-30 flex items-center gap-8 text-gray-700">
